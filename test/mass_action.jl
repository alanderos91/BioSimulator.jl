...
r[:zero] = Reaction("Immigration", "k0", [0,0,0], [1,0,0])
param["k0"] = 0.1

# First-Order Reaction: X ---> 0
r[:first] = Reaction("Death", "k1", [1,0,0],[0,0,0])
param["k1"] = 0.01

# Second-Order Reaction: X + Y ---> XY
r[:second_a] = Reaction("Dimerization_XY", "k2a", [1,1,0], [0,0,1])
param["k2a"] = 0.25

# Second-Order Reaction: X + X ---> Y
r[:second_b] = Reaction("Dimerization_Y", "k2b", [2,0,0], [0,1,0])
param["k2b"] = 0.5
