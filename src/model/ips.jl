...
function IPSReactionStruct(pairwise, i1, i2, o1, o2, class, rate)
  IPSReactionStruct(pairwise, i1, i2, o1, o2, class, rate, MassAction())
end
...
# case: MassAction
function rate(::MassAction, reaction::IPSReactionStruct, lattice, enumeration)
...
# case: ConstantLaw
function rate(::ConstantLaw, reaction::IPSReactionStruct, lattice, enumeration)
  # grab reactant indices
  class = enumeration.class
  s = reaction.class
