...
@time result = simulate(network, SSA, time = 500.0, epochs = 500, trials = 1_000)

plot(MeanTrajectory(result, "lactose"))
plot!(MeanTrajectory(result, "I"))
plot!(MeanTrajectory(result, "Z"))
plot!(MeanTrajectory(result, "r"))
